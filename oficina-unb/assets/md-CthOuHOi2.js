import{L as e,T as t,Y as n,_ as r,b as i,g as a,gt as o,mt as s,v as c}from"./modules/shiki-BiiZU2CK.js";import{n as l,t as u}from"./slidev/context-CitRXyF7.js";import{t as d}from"./slidev/default-FzZMvvLY.js";var f={__name:`oficina-unb.md__slidev_51`,setup(f){let{$slidev:p,$nav:m,$clicksContext:h,$clicks:g,$page:_,$renderContext:v,$frontmatter:y}=l();return h.setup(),(l,f)=>(e(),r(d,o(t(s(u)(s(y),50))),{default:n(()=>[f[0]||=a(`div`,{class:`oficina-canvas amazonia-slide`},[a(`h1`,{class:`slide-title pos-title-left title-tight`},`Variação regional e continuidade comunicativa`),a(`section`,{class:`amazonia-block`},[a(`p`,{class:`amazonia-lead`},`Finbow reconhece diferenças regionais, mas lê as fontes coloniais como evidência de continuidade comunicativa.`),a(`div`,{class:`amazonia-cycle`},[a(`p`,null,[a(`span`,null,`Anchieta`),i(`poesia com traços “sulistas” e “nortenhos”`)]),a(`p`,null,[a(`span`,null,`séc. XVII`),i(`paulistas chamados para missões no Maranhão e Pará`)]),a(`p`,null,[a(`span`,null,`motivo prático`),i(`fluência em sua variedade de Língua Geral`)])]),a(`div`,{class:`amazonia-keypoint`},[a(`p`,{class:`point-label`},`Ponto-chave`),a(`p`,null,`A distinção Tupinambá/Tupi Antigo pode ser útil para trajetórias posteriores, mas as fontes antigas sugerem variedades regionais ainda amplamente inteligíveis.`)])]),a(`p`,{class:`source finbow-source`},[i(`Finbow, Thomas. “The Nature and Emergence of the Língua Geral Amazônica according to Mufwene’s Language Ecology Model.” `),a(`em`,null,`Revista do GEL`),i(`, 19(2), 2022, p. 79.`)]),c(` <DeckImage
