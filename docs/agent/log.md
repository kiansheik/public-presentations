...
- Swapped the side images on the retomadas overview, Potiguara, and Tupinambá slides to Toré PDF-derived visuals and added context from the supplied computational grammar/Toré PDFs around Potiguara Tupi, Tupinambá Tupi, and community-adapted revitalization.
