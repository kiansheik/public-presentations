...
<div class="oficina-canvas">
  ...
  <section class="body-block pos-left-standard source-quote-block">
    <blockquote class="quote-text">
      ...
      naturales della; permitimos que desta<br>
      se pueda usar, y no de otro ninguna”
    </blockquote>
    <p class="source">
      Primer Concilio Limense (1551),<br>
      constituciones para la doctrina; f. 26v, na<br>
      edição em Vargas Ugarte (1951, p. 7)
    </p>
  </section>

  <DeckImage class="manuscript pos-limense" image="limense-1551-constituciones.png" alt="Constituciones de los naturales, Primer Concilio Limense" />
</div>

<!--
Antes de falar do Brasil, vale olhar para o mundo colonial ibérico mais amplo. No Primeiro Concílio Limense, em 1551, as autoridades eclesiásticas já formularam uma solução prática para a evangelização em territórios multilíngues: quando houvesse uma língua indígena “mais geral”, mais usada entre os naturais, essa língua deveria ser usada para a doutrina.

Isso não significa que a Igreja reconhecesse essas línguas como iguais ao latim ou ao espanhol, nem como línguas oficiais no sentido moderno. Significa que, para catequizar, confessar e ensinar, era necessário passar por línguas indígenas de grande circulação. Esse modelo ajuda a entender o que os jesuítas fariam no Brasil: eles não inventaram do nada uma língua de missão; eles se aproveitaram de uma língua indígena já amplamente usada na costa e a transformaram em objeto de gramáticas, catecismos e ensino religioso.
-->
...
<div class="oficina-canvas">
  ...
  <section class="body-block pos-left-standard source-quote-block">
    ...
    <blockquote class="quote-text compact">
      ...
      sean admitidos a Doctrinas, sin saber<br>
      la lengua general de los Indios, que<br>
      han de administrar.”
    </blockquote>
    <p class="source">
  ...
  <DeckImage class="manuscript pos-doctrinas" image="recopilacion-1681-doctrinas.png" alt="Recopilación de leyes de los reynos de las Indias, lei sobre doutrinas" />
</div>
...
<div class="oficina-canvas">
  ...
  <DeckImage class="manuscript pos-catedra" image="recopilacion-1681-catedra-lengua-general.png" alt="Detalhe sobre cátedra de língua geral na Recopilación de leyes" />
</div>
...
<div class="oficina-canvas">
  ...
  <DeckImage class="manuscript overlay pos-quechua-detail" image="quechua-orthography-detail.png" alt="Detalhe de ortografia quechua" />
</div>

<!--
O caso do Quechua é especialmente útil porque os próprios títulos das obras dizem “língua geral”. Isso nos ajuda a entender que o termo não significava “língua oficial” no sentido moderno de um Estado-nação, mas uma língua indígena escolhida como meio privilegiado de catequese e comunicação colonial.
-->
...
<div class="oficina-canvas">
  ...
  <DeckImage class="manuscript overlay pos-nahuatl-small" image="nahuatl-olmos-title.png" alt="Grammaire de la langue Nahuatl ou Mexicaine, Andrés de Olmos" />
</div>

<!--
O Nahuatl é importante aqui porque mostra que a ideia de descrever uma língua indígena ampla, ensinável e útil para a catequese não começa no Brasil. Quando Anchieta publica sua gramática em 1595, já havia uma tradição americana de transformar grandes línguas indígenas em objetos de gramática missionária.
-->
...
<!--
O Guarani mostra como esse modelo continuou no século XVII. A gramática e o vocabulário de Montoya não são uma origem isolada, mas parte de uma tradição missionária já consolidada: aprender línguas indígenas amplas, descrevê-las segundo categorias gramaticais europeias e usá-las como instrumentos de evangelização.

O Guarani pertence à mesma grande família linguística do Tupi e tornou-se uma das línguas centrais das missões jesuíticas no sul da América. A obra de Ruiz de Montoya, publicada em 1640, aparece depois de Anchieta, mas faz parte da mesma classe de produção missionária: gramáticas, vocabulários e textos religiosos voltados à aprendizagem, catequese e uso cotidiano da língua nas missões.

Nesse caso, a comparação com o Tupi é especialmente interessante: não se trata de uma língua “criada” pelos jesuítas, mas de uma língua indígena importante que os jesuítas estudaram, normatizaram por escrito e incorporaram a seu projeto missionário.

Ponto-chave:
Guarani é contemporâneo posterior ao Tupi de Anchieta e mostra a continuidade da tradição jesuítica de gramatizar línguas indígenas de grande alcance.
-->
...
<div class="oficina-canvas">
  <h1 class="slide-title pos-title-wide">Uma mesma classe de projetos coloniais</h1>

  <section class="body-block pos-left-wide">
    <p>Quechua, Nahuatl, Guarani e Tupi não são a mesma coisa, nem tiveram a mesma história.</p>
    <p>Mas entram em uma mesma classe colonial:</p>
    <ul class="visual-bullets">
      <li>línguas indígenas de grande circulação</li>
      <li>descritas em gramáticas e vocabulários</li>
      <li>ensinadas a missionários</li>
      <li>usadas na catequese</li>
      <li>transformadas em instrumentos de mediação colonial</li>
    </ul>
  </section>

  <DeckImage class="manuscript collage-image collage-quechua" image="quechua-vocabulario-holguin.png" alt="Vocabulario quechua" />
  <DeckImage class="manuscript collage-image collage-nahuatl" image="nahuatl-carochi-1645.png" alt="Arte da língua mexicana" />
  <DeckImage class="manuscript collage-image collage-guarani" image="guarani-montoya-1640.png" alt="Arte e vocabulário guarani" />
  <DeckImage class="manuscript collage-image collage-tupi" image="anchieta-arte-grammatica.png" alt="Arte de grammatica da lingva mais usada na costa do Brasil" />
</div>

<!--
O objetivo dessa comparação não é dizer que Nahuatl, Quechua, Guarani e Tupi tiveram trajetórias idênticas. O ponto é mostrar que elas pertencem a um mesmo tipo de resposta colonial ao multilinguismo americano: escolher ou aproveitar línguas indígenas de grande circulação e transformá-las em línguas de doutrina, ensino e mediação.
-->
...
<div class="oficina-canvas">
  ...
  <section class="concept-block">
    <p>Talvez a pergunta mais útil não seja:</p>
    <p class="concept-question">“O que é a Língua Geral?”</p>
    <p>mas sim:</p>
    <p class="concept-question">“O que é uma língua geral?”</p>
    <p class="concept-answer">uma língua indígena de grande circulação, escolhida ou aproveitada como meio de catequese, ensino e mediação colonial.</p>
  </section>
</div>
...
<div class="oficina-canvas brasil-slide">
  ...
  <DeckImage style="top:-0.8%" class="manuscript pos-anchieta-main" image="cardimtratados.png" alt="um texto jesuítico descrevendo a extensão da Língua Geral na costa brasileira. (Cardim, 1925 [1584], p. 194)" />
  <p class="corpus-footer">Referência curta: Cardim, <em>Fernão. Tratados da terra e gente do Brasil. Rio de Janeiro: J. Leite & Cia., 1925 [1584]. Textos do séc. XVI (inclui materiais redigidos no período colonial; frequentemente citados com data do manuscrito, p.ex. 1584).</em></p>
</div>
...
<div class="oficina-canvas brasil-slide">
  ...
  <DeckImage class="manuscript pos-anchieta-main" image="sousatop.png" alt="Um trecho jesuítico descrevendo a extensão da Língua Geral na costa brasileira em muitas detalhes (Sousa, 1938 [1587], p. 351)." />

  <p class="corpus-footer">Referência curta: SOUSA, Gabriel Soares de. <em>Tratado descriptivo do Brasil em 1587. Ed. by Francisco Adolfo de Varnhagen. São Paulo: Companhia Editora Nacional, 1938 [1587]. Edição da série Brasiliana; obra originalmente escrita em 1587.</em></p>
</div>
  ...
  <section class="corpus-definition-block">
    ...
    <div class="definition-columns">
      ...
      <div>
        ...
        <p>cartas e usos escritos raros, ligados a autores Potiguara.</p>
      </div>
      <div>
...
<div class="oficina-canvas section-divider-slide">
  ...
  <p class="section-divider-copy">Depois de mapear o corpus, voltamos a Anchieta para perguntar como uma gramática missionária lidava com variação.</p>
  <section class="section-divider-points">
...
<div class="amazonia-keypoint">
  ...
  <p>Se sua variedade era útil para converter Tupinambá amazônicos, a distância entre a variedade do sul e a do norte provavelmente não era percebida como a de línguas separadas.</p>
</div>
  </section>
...
<div class="oficina-canvas distribution-map-slide">
  <section style="display: grid; grid-template-columns: 1fr 1fr; gap: 1rem; width: 100%; height: 100%;">
    <DeckImage image="manuscrito.jpg" alt="Manuscrito 1089" style="width: 100%; height: 100%; object-fit: contain;" />
    <DeckImage image="facsimile.png" alt="Exemplar de facsimile" style="width: 100%; height: 100%; object-fit: contain;" />
  </section>
</div>
...
<div class="oficina-canvas retomada-slide">
  ...
  <p class="retomada-source">Araújo da Silva, <em>A Língua Tupinambá nas músicas do Ritual do Toré</em>, slide “Nada para nós sem nós”; Navarro, <em>Método Moderno de Tupi Antigo</em> (2005) e <em>Dicionário de Tupi Antigo</em> (2013).</p>
</div>

<!--
Aqui é importante separar Tupi Antigo de Nheengatu. O Nheengatu é uma língua viva amazônica, descendente da Língua Geral. O Tupi Antigo, como corpus colonial costeiro, não tem falantes nativos confirmados hoje. Mas isso não significa que esteja morto: ele está sendo retomado, ensinado, recriado e usado em novos contextos. A formulação aqui chama atenção para três variedades modernas em retomada, Potiguara Tupi, Tupinambá Tupi e Tupinakyîa Tupi, baseadas no corpus antigo, mas adaptadas a comunidades vivas.
-->
...
<div class="oficina-canvas retomada-slide">
  ...
  <p class="retomada-source">Araújo da Silva, <em>A Língua Tupinambá nas músicas do Ritual do Toré</em>, slides “Toré Rorypaba” e “A revitalização do Tupi e o protagonismo Potiguara”; Araújo da Silva Guyraakanga Potiguara, <em>Tupi Potiguara Kuapa</em> (2024); Cabral (2024).</p>
</div>
...
<div class="oficina-canvas retomada-slide">
  ...
  <p class="retomada-source">Araújo da Silva, <em>A Língua Tupinambá nas músicas do Ritual do Toré</em>, slide “Tupinambá de Olivença”; Costa (2013); Santos & Porto (2020); Santana & Cohn (2018); Pavelic (2023).</p>
</div>

<!--
No caso Tupinambá, eu enfatizaria que a língua não aparece isolada: ela está ligada à escola, à cultura, ao território e à política de consulta. Isso ajuda o público da História a ver que revitalização linguística também é história indígena contemporânea. O cuidado terminológico também é importante aqui: chamar o corpus antigo simplesmente de “Tupinambá” apaga que Tupinambá Tupi hoje é uma retomada contemporânea própria.
-->
...
<div class="oficina-canvas retomada-slide">
  ...
  <section class="retomada-right-stack">
    <div class="retomada-bullets-card">
      <p class="retomada-card-label">Fontes e circulação</p>
      <ul class="retomada-list">
        <li>Navarro como base didática e lexical;</li>
        <li>uso público em vídeos, filmes e música;</li>
        <li>Akangatara Produções como referência audiovisual.</li>
      </ul>
    </div>
    <p class="retomada-right-note">Aqui, a evidência principal não é uma edição acadêmica do projeto, mas a circulação pública em rede.</p>
  </section>
  <p class="retomada-source">Navarro, <em>Método Moderno de Tupi Antigo</em> (2005); Navarro, <em>Dicionário de Tupi Antigo</em> (2013); Akangatara Produções.</p>
</div>
...
<div class="oficina-canvas retomada-slide retomada-media-slide">
  ...
  <div class="retomada-media-collage" aria-hidden="true">
    <DeckImage class="manuscript retomada-media-img media-dic" image="qualification-dic.png" alt="Dicionário digital de Tupi Antigo" />
    <DeckImage class="manuscript retomada-media-img media-gint" image="qualification-gint.png" alt="Gramática interativa de Tupi Antigo" />
    <DeckImage class="manuscript retomada-media-img media-trad" image="qualification-trad.png" alt="Tradutor experimental de Tupi Antigo" />
    <DeckImage class="manuscript retomada-media-img media-quiz" image="qualification-quiz.png" alt="Quiz de conjugação em Tupi Antigo" />
  </div>

  <p class="retomada-source">Navarro, <em>Método Moderno de Tupi Antigo</em> (2005) e <em>Dicionário de Tupi Antigo</em> (2013); Akangatara Produções; Araújo da Silva Guyraakanga Potiguara, <em>Tupi Potiguara Kuapa</em> (2024).</p>
</div>
...
<div class="oficina-canvas retomada-slide retomada-closing-slide">
  ...
  <p class="retomada-source">Síntese a partir de Navarro (2005, 2013), Araújo da Silva Guyraakanga Potiguara (2024), Cabral (2024), Costa (2013), Santos & Porto (2020) e Akangatara Produções.</p>
</div>
